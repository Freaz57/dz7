...
//     console.log(product.price * 0.15);
// })
...
const resultFilter = products.filter(product => product.photos && product.photos.length > 0);
...
const contactArray = en.map((key, index) => [key, ru[index]])
console.log(contactArray)
const resultArray = Object.fromEntries(contactArray);
